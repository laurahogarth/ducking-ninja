...
describe HolidaysController do
  ...
  let(:valid_attributes) { { "country" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved holiday as @holiday" do
        ...
        post :create, {:holiday => { "country" => "invalid value" }}, valid_session
        expect(assigns(:holiday)).to be_a_new(Holiday)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested holiday" do
        ...
        expect_any_instance_of(Holiday).to receive(:update).with({ "country" => "1" })
        put :update, {:id => holiday.to_param, :holiday => { "country" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the holiday as @holiday" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Holiday.any_instance.stub(:save).and_return(false)
        put :update, {:id => holiday.to_param, :holiday => { "country" => "invalid value" }}, valid_session
        expect(assigns(:holiday)).to eq(holiday)
      end
